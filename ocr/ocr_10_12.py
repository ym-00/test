...
def create_descriptors(folder):
    ...
    ocr_c = PaddleOCR(det_model_dir='D:/project/module/ocr/out/det/db_mv3_5_infer/', use_angle_cls=False, use_gpu=False, lang='en', show_log=False)
    files = []
...
def main():
    ...
    rec_circles('D:/project/module/ocr/output')
def salt(img, n):
    # 椒盐去燥
    for k in range(n):
