...
with warnings.catch_warnings():
    ...
    data_s = np.loadtxt('xianduan/information/data_jiehe_shuzhi.txt')
if data_s.ndim==1:
...
for data in data_s:
    ...
    file.write('\n')
    file.close()
shutil.copyfile("xianduan/information/data_nihe.txt","xianduan/xianduan/xianduanjiance/"+classfy+"_result/"+imgname+"/data_result.txt")
...
cv2.imencode('.jpg', img)[1].tofile("xianduan/xianduan/xianduanjiance/"+classfy+"_result/"+imgname+"/result.jpg")
open("xianduan/xianduan/xianduanjiance/"+classfy+"_result/"+imgname+"/data_result_belong.txt", "w").close()
data_s = np.loadtxt("xianduan/xianduan/xianduanjiance/"+classfy+"_result/"+imgname+"/data_result.txt",dtype=int)
for data in data_s:
    x1, y1, x2, y2 = data
    x1 = np.int0(x1)
    y1 = np.int0(y1)
    ...
    # if x1 == 0 and x2 == 0 and y1 == 0 and y2 == 0:
    #     continue
    file = open("xianduan/xianduan/xianduanjiance/"+classfy+"_result/"+imgname+"/data_result_belong.txt", 'a')
    file.write(str(x1))
    file.write(' ')
    file.write(str(y1))
    file.write(' ')
